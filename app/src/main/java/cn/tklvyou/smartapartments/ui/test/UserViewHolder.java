 ...
 * @author Lemon
 * @use
 * <br> UserViewHolder userView = new UserViewHolder(context, resources);
 ...
 */
public class UserViewHolder extends BaseViewHolder<User> implements OnClickListener {
	private static final String TAG = "UserViewHolder";

	public UserViewHolder(Activity context, ViewGroup parent) {
